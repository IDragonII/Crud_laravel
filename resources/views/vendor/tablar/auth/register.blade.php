...
@section('content')
            ...
            <div class="form-group mb-4">
                ...
                <div class="mb-3">
                    <label class="form-check">
                        ...
                        <span class="form-check-label">Acepta los <a href="#" tabindex="-1">términos y políticas</a>.</span>
                    </label>
                </div>
    ...
    <script src="https://unpkg.com/@popperjs/core@2.10.2/dist/umd/popper.min.js" integrity="sha384-d7k5Sx/5ImZMsDSZUEx7F7YqWJYZ5flXn/7J8Y1G4QpPe5fge4xu4PAevoMMKtM" crossorigin="anonymous"></script>
    <script src="https://unpkg.com/bootstrap@5.3.0/dist/js/bootstrap.min.js" integrity="sha384-eQ8C+0Np5A1U2tAq66DddBv1nv9H66l9NqSH8g6JhFXwEp9F9Z0BtXQdvvkg8ONt" crossorigin="anonymous"></script>
    <!-- Initialize tooltips manually if using Bootstrap 5 -->
    <script>
