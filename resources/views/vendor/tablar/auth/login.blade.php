...
@section('content')
    <div class="container container-tight py-4">
        ...
        <div class="card card-md">
                ...
                <form action="{{route('login')}}" method="post" autocomplete="off" novalidate>
                    ...
                    <div class="mb-2">
                        <label class="form-check">
                            ...
                            <span class="form-check-label">Recordar cuenta</span>
                        </label>
                    </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col"><a href="{{ route('social.redirect', 'github') }}" class="btn btn-white w-100">
                    ...
                    <div class="col"><a href="{{ route('social.redirect', 'twitter') }}" class="btn btn-white w-100">
        ...
        <div class="text-center text-muted mt-3">
           No tienes una cuenta <a href="{{route('register')}}" tabindex="-1">Registrar</a>
        </div>
    </div>
@endsection
